...
import PaymentThumb from 'assets/banner3.png';
import PaymentPattern from 'assets/payment-pattern.png';

const data = {
  subTitle: 'Predicting the Future',
  title: 'Forecast like never before with Artificial Intelligent Mind',
  description:
    'Transform your forecasting with the advanced technology of Artificial Intelligent Mind. Discover the future of predictions with AI-powered precision.',
  // btnName: 'Learn More',
  btnURL: '#',
};
