...
import CoreFeatureThumb from 'assets/banner2.png';
  ...
  features: [
    {
      ...
      text:
        'Capturing, storing, manipulating, analyzing, managing, and presenting all types of geographical data.',
    },
    {
      id: 2,
      imgSrc: Secure,
      ...
      text:
        'Performance and characteristics of specific items or its export and import.',
    },
  ],
};
